...
from .preprocessing import RandomErasing_Background,AddLocalSaltNoise,RandomErasing_Backgroundpro
__factory = {
...
def make_dataloader(cfg):
    ...
    eraser_transforms = T.Compose([
            ...
            T.ToTensor(),
            T.Normalize(mean=cfg.INPUT.PIXEL_MEAN, std=cfg.INPUT.PIXEL_STD),
            RandomErasing_Backgroundpro(EPSILON=1,root=os.path.join('/opt/data/private/yfz/NFormer-main/data/occluded_dukemtmc',
                                                      'bounding_box_train')),
